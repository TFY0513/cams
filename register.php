        ...
        <div class="container" >
            <main>  
                <div class="col d-flex justify-content-center">
                    <div class="card" style="background-color:powderblue; width:70%;">
                        <div class="card-body">
                        ...
                        <div >
                            ...
                            <div class="">
                                ...
                                <form class="needs-validation" action="verification.php" novalidate>
                                    <div class="row g-3">
                                    ...
                                    <a  style="padding-left:20px;"  href="login.php">Login</a>  
                             

                                     <center><button  class="btn btn-primary btn-lg" type="submit">Register</button> </center>
                                </form>
                            </div>
                        </div>
