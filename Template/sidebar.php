                    ...
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <div class="nav-sub-functional">
                                <li style="margin-left:10px;" class="nav-item">
                                    <a class="nav-link" href="../PM/Project.php" style="color:gray;">
                                        <span data-feather="file"></span>
                                        Project
                                    </a>
                                </li>
                                <li style="margin-left:10px;" class="nav-item">
                                    <a class="nav-link" href="../PM/Project_Task.php">
                                        <span data-feather="file"></span>
                                        Project Task
                                    </a>
                                </li>
                                <li style="margin-left:10px;" class="nav-item">
                                    <a class="nav-link" href="../PM/Project_Working_Calendar.php">
                                        <span data-feather="file"></span>
                                        Working Calendar
                                    </a>
                                </li>
                                <li style="margin-left:10px;" class="nav-item">
                                    <a class="nav-link" href="../PM/Project_Member.php">
                                        <span data-feather="file"></span>
                                        Project Member
                                    </a>
                                </li>
                                <li style="margin-left:10px;" class="nav-item">
                                    <a class="nav-link" href="../PM/Project_Manager.php">
                                        <span data-feather="file"></span>
                                        Project Manager 
                                    </a>
                                </li>   
                            ...
                            <div class="nav-sub-functional">
                                <li style="margin-left:10px;" class="nav-item">
                                    ...
                                    <a class="nav-link" href="../Profile/changePassword.php">
                                        <span data-feather="file"></span>
                                        Change Password
                                    </a>
                                </li>
