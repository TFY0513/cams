            ...
            <div class="container">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
                        <h4 class="h4">Document Template</h4>
                        <div class="ms-auto">
                            <a>Document Approval</a> 
                            / <b><a>Document Template</a></b>
                        </div>
                    </div>
                </div>
                <br/>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-12">
                                        <a href="documentTemplateUpload.php">
                                            <button type="button" class="btn btn-outline-secondary">
                                                <i class="fa fa-plus" aria-hidden="true"></i> Upload Template
                                            </button>
                                        </a>
                                        <button type="button" class="btn btn-outline-secondary">
