    ...
    <body>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
             ...
             <h4 class="h4">Project Manager</h4>
            <div class="col d-flex justify-content-center">
                
                <div class="card" style="width:100%; height: 700px;">
                    <div class="card-body" >
                        <a href="Project_Manager_Add.php" class="btn btn-outline-secondary">Add New Project Manager</a><br/><br/>
                        <table class="table">
                           <thead>
                                <tr>
                                    <th scope="col">#</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td scope="col">Email</td>
                                      ...
                                      <td scope="col"><a href="Project_Manager_Edit.php">Edit</a></td>
