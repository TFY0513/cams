        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="col d-flex justify-content-center">
                <div class="card" style="width:100%; height: 700px;">
                    <div class="card-body" >
                        <a href="Project_Add.php" class="btn btn-outline-secondary">Create New Project</a><br/><br/>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row">1</td>
                                     ...
                                     <td scope="col"><a href="Project_View.php">View</a></td>
                                    <td scope="col"><a href="Project_Edit.php">Edit</a></td>
                                    <td scope="col"><a href="">Delete</a></td>
                                       <td scope="col"><a href="../ProjectTask/Project_Task_Add.php">Add Project Task</a></td>
                                </tr>
